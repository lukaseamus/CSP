...
##### Script purpose: Calculation and visualisation of per plant #####
#####                 and areal carbon export                    #####
...
#### 5.1.3 Standing stock ####
mass.stat2$prod <- mass.stat2$mean * d.stat$mean20
mass.stat2$se.prod <- sqrt(mass.stat2$se^2 * d.stat$se20^2 + mass.stat2$se^2 * d.stat$mean20^2 +
                           d.stat$se20^2 * mass.stat2$mean^2)
mass.stat2
